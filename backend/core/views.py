...
from businesses.models import Business, MerchantRedirectUrls, Webhooks
...
class SettingViewSet(ViewSet):
    ...
    def setting(self, request, allow_settings):
        if request.method == "GET":
            ...
            for key in request.data:
                if key in allow_settings and key in getattr(
    ...
    def create(self, request):
        ...
        """
        allow_settings = [
            key for key, options in getattr(settings, "CONSTANCE_CONFIG", {}).items()
        ]
